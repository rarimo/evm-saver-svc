...
func NewInfuraGateway(credentials []InfuraCredentials) Gateway {
	return &infuraGateway{
		client:      &http.Client{},
		credentials: credentials,
	}
}

type infuraGateway struct {
	client       *http.Client
...
func (c *infuraGateway) GetReader(ctx context.Context, resourceID string) (io.ReadCloser, error) {
	c.mu.Lock()
...
func (c *infuraGateway) Get(ctx context.Context, resourceID string) ([]byte, error) {
